...
import static com.javahe.rxjava.util.Preconditions.checkElementIndex;
import static com.javahe.rxjava.util.Preconditions.checkNotNull;
import static com.javahe.rxjava.util.Preconditions.checkPositionIndex;
import static com.javahe.rxjava.util.Preconditions.checkPositionIndexes;
import static com.javahe.rxjava.util.Preconditions.checkRemove;
import static com.javahe.rxjava.util.Preconditions.checkState;
...
public class CollectionUtils {
    ...
    /**
     * Reverses the order of the given collection.
     *
     * @param coll the collection to reverse
     */
    public static <T> void reverseList(final List<T> coll) {
        T[] objects = (T[]) coll.toArray();
        reverseArray(objects);
        coll.clear();
        coll.addAll(Arrays.asList(objects));
    }
     ...
     * CollectionUtils.reverse(Arrays.asList(1, 2, 3))} returns a list containing {@code 3,
    ...
    public static <T> List<T> reverse(List<T> list) {
        if (list instanceof CollectionUtils.ReverseList) {
            return ((CollectionUtils.ReverseList<T>) list).getForwardList();
        } else if (list instanceof RandomAccess) {
            return new CollectionUtils.RandomAccessReverseList<>(list);
        } else {
            return new CollectionUtils.ReverseList<>(list);
        }
    }
    ...
    private static class RandomAccessReverseList<T> extends CollectionUtils.ReverseList<T> implements RandomAccess {
